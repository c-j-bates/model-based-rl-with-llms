(define (problem lvtest)
    ...
    (:init
        ...
        (at keke_word_1 loc-1-8)
        (at is_word_1 loc-1-7)
        (at is_word_2 loc-7-7)
        (at is_word_3 loc-7-1)
        (at move_word_1 loc-1-6)
        (at baba_word_1 loc-4-7)
        (at flag_word_1 loc-6-1)
        (at you_word_1 loc-8-7)
        (at win_word_1 loc-8-1)
        (at keke_obj_1 loc-2-7)
        (at baba_obj_1 loc-3-4)
        (at flag_obj_1 loc-5-4)

         ; formed rules

        (rule_formed flag is win)
        (rule_formed keke is move)
        ...
        ; (rule_formed move_word_1 is_word_1 keke_word_1)
