(define (problem level13)
    ...
    (:init
        ...
        (at lava_word_1 loc-1-5)
        (at is_word_1 loc-1-4)
        (at is_word_2 loc-2-1)
        (at is_word_3 loc-7-4)
        (at is_word_4 loc-7-1)
        (at hot_word_1 loc-1-3)
        (at baba_word_1 loc-1-1)
        (at baba_word_2 loc-7-5)
        (at you_word_1 loc-3-1)
        (at flag_word_1 loc-6-1)
        (at melt_word_1 loc-7-3)
        (at win_word_1 loc-8-1)
        (at lava_obj_1 loc-1-6)
        (at lava_obj_2 loc-2-6)
        (at lava_obj_3 loc-3-6)
        (at lava_obj_4 loc-4-6)
        (at lava_obj_5 loc-5-6)
        (at lava_obj_6 loc-6-6)
        (at lava_obj_7 loc-7-6)
        (at lava_obj_8 loc-8-6)
        (at flag_obj_1 loc-4-8)
        (at baba_obj_1 loc-5-4)

         ; formed rules

        (rule_formed baba_word_1 is_word_2 you_word_1)
        (rule_formed lava_word_1 is_word_1 hot_word_1)
        (rule_formed flag_word_1 is_word_4 win_word_1)
        (rule_formed baba_word_2 is_word_3 melt_word_1)
    ...
    (:goal (and
        ...
        (not (rule_formed baba_word_2 is_word_3 melt_word_1))
        (at baba_obj_1 loc-4-8)
