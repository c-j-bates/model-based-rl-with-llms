(define (problem level9)
    ...
    (:init
        ...
        (at wall_word_1 loc-2-5)
        (at is_word_1 loc-2-4)
        (at is_word_2 loc-2-1)
        (at is_word_3 loc-7-1)
        (at stop_word_1 loc-2-3)
        ...
        (at flag_obj_1 loc-5-8)
        (at baba_obj_1 loc-5-4)

         ; formed rules

        (rule_formed baba_word_1 is_word_2 you_word_1)
        (rule_formed wall_word_1 is_word_1 stop_word_1)
    ...
    (:goal (and
        ...
        (not (rule_formed wall_word_1 is_word_1 stop_word_1))
        (at baba_obj_1 loc-5-8)
    ))
)
