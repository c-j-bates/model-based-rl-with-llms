(define (problem level12)
    ...
    (:init
        ...
        (at goop_word_1 loc-1-3)
        (at is_word_1 loc-1-2)
        (at is_word_2 loc-2-8)
        (at is_word_3 loc-2-7)
        (at is_word_4 loc-3-1)
        (at sink_word_1 loc-1-1)
        (at rock_word_1 loc-2-1)
        (at you_word_1 loc-3-8)
        (at win_word_1 loc-3-7)
        (at push_word_1 loc-4-1)
        (at goop_obj_1 loc-1-6)
        (at goop_obj_2 loc-1-5)
        (at goop_obj_3 loc-1-4)
        (at goop_obj_4 loc-3-6)
        (at goop_obj_5 loc-3-5)
        (at goop_obj_6 loc-3-4)
        (at goop_obj_7 loc-3-3)
        (at goop_obj_8 loc-4-8)
        (at goop_obj_9 loc-4-7)
        (at goop_obj_10 loc-4-6)
        (at goop_obj_11 loc-4-5)
        (at goop_obj_12 loc-4-4)
        (at goop_obj_13 loc-4-3)
        (at goop_obj_14 loc-5-8)
        (at goop_obj_15 loc-5-7)
        (at goop_obj_16 loc-5-6)
        (at goop_obj_17 loc-5-5)
        (at goop_obj_18 loc-5-4)
        (at goop_obj_19 loc-5-3)
        (at goop_obj_20 loc-5-1)
        (at goop_obj_21 loc-6-5)
        (at goop_obj_22 loc-6-4)
        (at goop_obj_23 loc-7-5)
        (at goop_obj_24 loc-7-4)
        (at goop_obj_25 loc-8-5)
        (at goop_obj_26 loc-8-4)
        (at baba_obj_1 loc-2-6)
        (at flag_obj_1 loc-7-7)
        (at rock_obj_1 loc-7-3)
        (at rock_obj_2 loc-8-3)

         ; formed rules

        ; (rule_formed sink_word_1 rock_word_1 is_word_4) change autogen to only consider rules where is word is in middle
        (rule_formed goop_word_1 is_word_1 sink_word_1)
        (rule_formed flag_word_1 is_word_3 win_word_1)
        (rule_formed baba_word_1 is_word_2 you_word_1)
        (rule_formed rock_word_1 is_word_4 push_word_1)

        ; manual section 
        (is-controllable baba_obj_1)
        (movable rock_obj_1)
        (movable rock_obj_2)
        (clear_path loc-2-6)
       ...
       ; occupancies section
        ...
        (adjacent loc-9-0 loc-9-1 vertical)
        (adjacent loc-9-0 loc-8-0 horizontal)
        (adjacent loc-9-1 loc-9-0 vertical)
        (adjacent loc-9-1 loc-9-2 vertical)
        (adjacent loc-9-1 loc-8-1 horizontal)
        (adjacent loc-9-2 loc-9-1 vertical)
        (adjacent loc-9-2 loc-9-3 vertical)
        (adjacent loc-9-2 loc-8-2 horizontal)
        (adjacent loc-9-3 loc-9-2 vertical)
        (adjacent loc-9-3 loc-9-4 vertical)
        (adjacent loc-9-3 loc-8-3 horizontal)
        (adjacent loc-9-4 loc-9-3 vertical)
        (adjacent loc-9-4 loc-9-5 vertical)
        (adjacent loc-9-4 loc-8-4 horizontal)
        (adjacent loc-9-5 loc-9-4 vertical)
        (adjacent loc-9-5 loc-9-6 vertical)
        (adjacent loc-9-5 loc-8-5 horizontal)
        (adjacent loc-9-6 loc-9-5 vertical)
        (adjacent loc-9-6 loc-9-7 vertical)
        (adjacent loc-9-6 loc-8-6 horizontal)
        (adjacent loc-9-7 loc-9-6 vertical)
        (adjacent loc-9-7 loc-9-8 vertical)
        (adjacent loc-9-7 loc-8-7 horizontal)
        (adjacent loc-9-8 loc-9-7 vertical)
        (adjacent loc-9-8 loc-9-9 vertical)
        (adjacent loc-9-8 loc-8-8 horizontal)
        (adjacent loc-9-9 loc-9-8 vertical)
        (adjacent loc-9-9 loc-8-9 horizontal)
    ...
    (:goal (and
        ...
        ; (at rock_obj_1 loc-7-3)
        ; (at rock_obj_2 loc-8-3)
        ; (at rock_obj_2 loc-8-4)
        ; (at rock_obj_1 loc-8-5)
        (at rock_obj_2 loc-8-5)
        (at rock_obj_1 loc-8-4)
        (at baba_obj_1 loc-7-7)
    ))
)
