(define (problem level8)
    ...
    (:init
        ...
        (rule_formed keke_word is_word_1 move_word)
        (rule_formed flag_word is_word_3 win_word)
        ...
        (at baba_word loc-6-7)

        (at flag_word loc-6-1)
        (at keke_word loc-1-8)
        (at move_word loc-1-6)
