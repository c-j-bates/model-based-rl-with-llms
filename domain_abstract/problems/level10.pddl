(define (problem level10)
    ...
    (:init
        ...
        (at skull_word_1 loc-1-7)
        (at baba_word_1 loc-1-1)
        (at is_word_1 loc-2-7)
        (at is_word_2 loc-2-1)
        (at is_word_3 loc-7-1)
        (at kill_word_1 loc-3-7)
        (at you_word_1 loc-3-1)
        (at flag_word_1 loc-6-1)
        (at win_word_1 loc-8-1)
        (at baba_obj_1 loc-2-5)
        (at skull_obj_1 loc-5-6)
        (at skull_obj_2 loc-5-5)
        (at skull_obj_3 loc-5-4)
        (at skull_obj_4 loc-6-6)
        (at skull_obj_5 loc-6-4)
        (at skull_obj_6 loc-7-6)
        (at skull_obj_7 loc-7-5)
        (at skull_obj_8 loc-7-4)
        (at flag_obj_1 loc-6-5)

         ; formed rules

        (rule_formed baba_word_1 is_word_2 you_word_1)
        (rule_formed skull_word_1 is_word_1 kill_word_1)
    ...
    (:goal (and
        ...
        (not (rule_formed skull_word_1 is_word_1 kill_word_1))
        (at baba_obj_1 loc-6-5)
    ))
)
