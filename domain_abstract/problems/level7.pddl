(define (problem level7)
    ...
    (:init
        ...
        (not (is-controllable rock_obj_1))
        (not (is-controllable rock_obj_2))
        (not (is-controllable rock_obj_3))
        (not (is-controllable rock_obj_4))
        (not (is-controllable rock_obj_5))
        (not (is-controllable rock_obj_6))
        (not (is-controllable rock_obj_7))
        (not (is-controllable rock_obj_8))
