(define (problem level14)
    ...
    (:init
        ...
        (at baba_word_1 loc-1-2)
        (at is_word_1 loc-2-2)
        (at is_word_2 loc-7-1)
        (at is_word_3 loc-8-4)
        (at keke_word_1 loc-3-4)
        (at you_word_1 loc-3-2)
        (at flag_word_1 loc-6-1)
        (at wall_word_1 loc-8-5)
        (at stop_word_1 loc-8-3)
        (at win_word_1 loc-8-1)
        (at wall_obj_1 loc-1-6)
        (at wall_obj_2 loc-2-6)
        (at wall_obj_3 loc-3-6)
        (at wall_obj_4 loc-4-6)
        (at wall_obj_5 loc-5-6)
        (at wall_obj_6 loc-6-6)
        (at wall_obj_7 loc-7-6)
        (at wall_obj_8 loc-8-6)
        (at keke_obj_1 loc-3-7)
        (at flag_obj_1 loc-6-7)
        (at baba_obj_1 loc-6-4)

         ; formed rules

        (rule_formed baba_word_1 is_word_1 you_word_1)
        ; (not (rule_formed keke_word_1 is_word_1 you_word_1))
        (rule_formed flag_word_1 is_word_2 win_word_1)
        (rule_formed wall_word_1 is_word_3 stop_word_1)

        ; manual
        (is-controllable baba_obj_1)
        (clear_path loc-3-7)
        (valid_rule keke_word_1 is_word_1 you_word_1)
    ...
    (:goal (and
        ...
        ; (not (rule_formed baba_word_1 is_word_1 you_word_1))
        ; (rule_formed baba_word_1 is_word_1 you_word_1)
        (rule_formed keke_word_1 is_word_1 you_word_1)
        (is-controllable keke_obj_1)
        (at keke_obj_1 loc-6-7)
    ))
)
