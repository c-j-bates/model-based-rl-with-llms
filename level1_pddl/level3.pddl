(define (problem level3)
    ...
    (:objects
        ...
        baba_word is_word_1 is_word_2 you_word win_word
        baba_obj
    )
    ...
    (:init
        ...
        (not (unoccupied loc-4-7))
        (not (unoccupied loc-2-5))
        (not (unoccupied loc-6-7))

        (not (unoccupied loc-5-7))
        (not (unoccupied loc-2-4))
        (not (unoccupied loc-5-4))
